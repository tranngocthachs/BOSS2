...
public class PerformRunSherlockPage extends Page implements
SherlockProcessCallback {
	...
	public PerformRunSherlockPage() throws PageLoadException {
	...
	protected void handlePost(PageContext pageContext, Template template,
		...
		if (newSession) {
			...
			try {
				f.beginTransaction();
				selectedFiles = f.getSherlockSessionDAOInstance()
