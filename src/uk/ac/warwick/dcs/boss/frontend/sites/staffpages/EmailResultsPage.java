...
public class EmailResultsPage extends Page {
	
	public EmailResultsPage()
			throws PageLoadException {
		super("staff_email_results", AccessLevel.USER);
	}
	...
	protected void handleGet(PageContext pageContext, Template template,
		...
		try {
			...
			Collection<StaffResultsQueryResult> result = staffInterfaceQueriesDAO.performStaffResultsQuery(StaffResultsQuerySortingType.STUDENT_ID_ASCENDING, assignmentId);
