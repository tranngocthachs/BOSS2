...
public class AssignmentFilesPage extends Page {
	
	public AssignmentFilesPage()
			throws PageLoadException {
		super("staff_assignment_files", AccessLevel.USER);
	}
	...
	protected void handleGet(PageContext pageContext, Template template,
		...
		try {
			...
			Collection<String> result = assignmentDao.fetchRequiredFilenames(assignmentId);
			...
			templateContext.put("files", result);
