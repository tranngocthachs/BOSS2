...
public class UploadTestResourcePage extends Page {
	
	public UploadTestResourcePage()
			throws PageLoadException {
		super("staff_upload_test_resource", AccessLevel.USER);
	}
	...
	protected void handleGet(PageContext pageContext, Template template,
		...
		try {
			...
			Test test = testDao.retrievePersistentEntity(testId);
