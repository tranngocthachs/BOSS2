...
public class PerformAddModuleAdministratorPage extends Page {

	public PerformAddModuleAdministratorPage() throws PageLoadException {
	...
	protected void handlePost(PageContext pageContext, Template template,
		...
		try {
			...
			// Check the module exists (will throw an exception if not)
			moduleDao.retrievePersistentEntity(moduleId);

			// Add the administrator
			moduleDao.addAdministratorAssociation(moduleId, personId);
